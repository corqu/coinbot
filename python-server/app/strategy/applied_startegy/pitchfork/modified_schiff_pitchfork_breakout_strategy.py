...
from app.strategy.basic_startegy.pitchfork.modified_schiff_pitchfork import modified_schiff_pitchfork_lines_at
...
def pitchfork_snapshot(
    ...
    x = len(bars) - 1
    lines = modified_schiff_pitchfork_lines_at((a, b, c), x)
    if lines is None:
        return None
    return {
        "x_index": x,
